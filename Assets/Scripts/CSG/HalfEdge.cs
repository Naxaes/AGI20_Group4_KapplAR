...
/*
 * 
 * TODO: Problemet är normalerna. En idé är att använda per-face normals
 *       Vi gör det genom att spara en normal i HEFace.
 *       När vi sen återskapar meshen kan vi duplicera de vertex som behövs!
 */
