...
public static class Vibration
{
    ...
    {
        if ( Application.isMobilePlatform && streak < 1) {
            streak++;
#if UNITY_IOS
        _VibratePop ();
#elif UNITY_ANDROID
    ...
    {
        if ( Application.isMobilePlatform && streak < 3) {
            streak++;
#if UNITY_IOS
        _VibratePeek ();
#elif UNITY_ANDROID
    ...
    private static void DecreaseStreak(object source, ElapsedEventArgs e)
    {
        streak--;
    }
}
