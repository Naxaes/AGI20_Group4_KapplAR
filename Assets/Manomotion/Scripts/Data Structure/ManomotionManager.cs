...
public class ManomotionManager : ManomotionBase
{
   ...
   // public static Action<int, int> OnSkeleton3dActive;
    ...
    protected override void SetResolutionValues(int width, int height)
    {
        ...
        visualization_info.occlussion_rgb = new Texture2D(this.widthValue, this.heightValue);
        MRframePixelColors = new Color32[this.widthValue * this.heightValue];
    ...
    /// <summary>
    /// Lets the core know that it needs to calculate the Skeleton in 3D or 2D.
    /// </summary>
    ...
    /// <summary>
    /// Lets the core know that it needs to calculate the Gestures.
    /// </summary>
    /// <param name="condition"></param>
    ...
    /// <summary>
    /// Lets the core know if it should run fast mode or not.
    /// </summary>
    /// <param name="condition"></param>
